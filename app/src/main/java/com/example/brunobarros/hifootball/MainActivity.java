...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File file = getBaseContext().getFileStreamPath("teste.txt");
        ...
        if (file.exists())
        {
            ...
            try {
                ...
                OutputStreamWriter out = new OutputStreamWriter(openFileOutput("teste.txt", 0));
                out.write("1 2 3 4");
                out.close();
        ...
        try {
            ...
            final InputStream in = openFileInput("teste.txt");
            ...
            if (in != null) {
                ...
                if (btn2 != null) {
                    ...
                    final Intent intent = new Intent(this, linha2.class);

                    //adicionar evento ao botao!
                    btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Toast.makeText(MainActivity.this, "Mudar de equipa", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity.this, "O ficheiro em causa se encontra vazio!", Toast.LENGTH_SHORT).show();
            }
