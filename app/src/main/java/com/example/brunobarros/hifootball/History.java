    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sequipas.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                PHPConnection phpc = new PHPConnection(History.this, jsonclass);
                ...
                try {
                    ...
                    sjogadores.setAdapter(new ArrayAdapter<String>(History.this, android.R.layout.simple_spinner_dropdown_item, nomejogadrores));
                } catch (InterruptedException e) {
                    Toast.makeText(History.this, "Erro1", Toast.LENGTH_LONG).show();
                } catch (ExecutionException e) {
                    Toast.makeText(History.this, "Erro2", Toast.LENGTH_LONG).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
