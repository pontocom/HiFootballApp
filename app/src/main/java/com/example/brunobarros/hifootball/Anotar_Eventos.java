...
public class Anotar_Eventos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iniciar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (iniciar.getText().toString().equals("Terminou"))
                {
                    ...
                    startActivity(new Intent(cxt, Pagina_Inicial.class));
                }
            }
        });
        ...
        golo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!idj.equals("")) {
                    ...
                    estado.setState(getApplicationContext ());
                    startActivityForResult(new Intent(Anotar_Eventos.this, Pop.class).putExtra("IdJ",idj),2);
                }
            }
        });
        ...
        btfalta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*if (!idj.equals("")) {
                    if (btfalta.getText().equals("Falta O")) {
                ...
                if (!idj.equals("")) {
                    //inserireventotecnico("1", cxt);
                    estado.setState(getApplicationContext ());
                    startActivityForResult(new Intent(Anotar_Eventos.this, Falta.class).putExtra("IdJ",idj),2);
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!idj.equals("")) {
                    ...
                    if (idP.equals("0"))
                        ...
                        Toast.makeText(Anotar_Eventos.this, "Jogador nao escolhido", Toast.LENGTH_SHORT);
                }*/
                escolherexecutante();
                inserireventotecnico("24", cxt);
                tmp = modo;
                ...
                if (evento.equals("troca"))
                {
                    ...
                    else
                    {
                        ...
                        if (jogador1 != jogador2)
                        {
                            ...
                            Toast.makeText(Anotar_Eventos.this, "Nao se pode trocar os mesmo jogador", Toast.LENGTH_SHORT).show();
                    }
                    jogador1 = -1;
                    //Ativar bottoes
                }
                else {
                    //Toast.makeText(Anotar_Eventos.this, "Nao foi escolhido um evento.", Toast.LENGTH_SHORT).show();
                    idj = EquipaCasaIDJ[0];
                    idP = "0";
    ...
    public void cartoes (boolean visivel)
    {
        if (visivel)
        {
    ...
    public String inserireventotecnico (String acao, Context cxt)
    {
        ...
        //Toast.makeText(Anotar_Eventos.this, "Data: " + currentDateTimeString, Toast.LENGTH_SHORT).show();
        ...
        //Toast.makeText(Anotar_Eventos.this, resej, Toast.LENGTH_SHORT).show();
        return null;
    }

    public String inserirevento (String idj)
    {
        String currentDateTimeString = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(new Date());
        //Toast.makeText(Anotar_Eventos.this, "Data: " + currentDateTimeString, Toast.LENGTH_SHORT).show();
