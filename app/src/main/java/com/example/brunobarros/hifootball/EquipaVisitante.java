...
public class EquipaVisitante extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(EquipaVisitante.this, EquipadaCasa.class);
        ...
        iniciar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (iniciar.getText().toString().equals("Ini. 1ª Parte"))
                {
                    ...
                    Toast.makeText(EquipaVisitante.this, "Inicio do jogo.", Toast.LENGTH_LONG).show();
                    butoes(1);
                ...
                else if (iniciar.getText().toString().equals("Fim 1ª Parte"))
                {
                    ...
                    //anunciar o inicio do jogo
                    Toast.makeText(EquipaVisitante.this, "Fim da 1ª Parte do jogo.", Toast.LENGTH_LONG).show();
                    butoes(1);
                    //Chamar a funcao de actualizar os dados.
                ...
                else if (iniciar.getText().toString().equals("Ini. 2ª Parte"))
                {
                    ...
                    //anunciar o inicio do jogo
                    Toast.makeText(EquipaVisitante.this, "Inicio 2ª Parte do jogo.", Toast.LENGTH_LONG).show();
                    butoes(1);
                    //Chamar a funcao de actualizar os dados.
                    // comecar a contar o tempo da posse de bola
                    inicioposse = System.currentTimeMillis();
                ...
                else if (iniciar.getText().toString().equals("Fim 2ª Parte"))
                {
                    ...
                    //anunciar o inicio do jogo
                    Toast.makeText(EquipaVisitante.this, "Fim do jogo.", Toast.LENGTH_LONG).show();
                    butoes(1);
                    //Chamar a funcao de actualizar os dados.
                    actulizarVars(jsonclass);
                    // contabilizar o tempo, o atualizar vars ja faz a chamada, estou a duplicar
                ...
                else if (iniciar.getText().toString().equals("Terminou"))
                {
                    ...
                    PHPConnection phpc = new PHPConnection(EquipaVisitante.this, jsonclass);
                    try {
                        resej = phpc.execute(method).get();
                        //editor.clear();
                        //editor.commit();
                        Toast.makeText(EquipaVisitante.this, "Dados Inseridos com sucesso. " + resej, Toast.LENGTH_LONG).show();
                ...
                else if (iniciar.getText().toString().equals("Terminou"))
                {
                    ...
                    try {
                        ...
                        editor.commit();
                        Toast.makeText(EquipaVisitante.this, "Dados Inseridos com sucesso. " + resej, Toast.LENGTH_LONG).show();
                        i = new Intent(EquipaVisitante.this, Pagina_Inicial.class);
                        startActivity(i);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    } catch (ExecutionException e) {
        ...
        iniciar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (iniciar.getText().toString().equals("Ini. 1ª Parte")) {
                    ...
                    //i = new Intent(EquipadaCasa.this, EquipaVisitante.class);
                    actulizarVars(jsonclass);
                    i.putExtra("iniciar", "Ini. 1ª Parte");
                    i.putExtra("myclass", jsonclass);
                    startActivity(i);
        ...
        GR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (evento.equals("perda"))
                {
                    ...
                    //Toast.makeText(EquipadaCasa.this, Integer.toString(selectedPosition), Toast.LENGTH_SHORT).show();
                ...
                else if (evento.equals("troca"))
                {
                    ...
                    else
                    {
                        ...
                        if (jogador1 != jogador2)
                        {
                            ...
                            Toast.makeText(EquipaVisitante.this, "Nao se pode trocar os mesmo jogador", Toast.LENGTH_SHORT).show();
                    }
                    jogador1 = -1;
                    //Ativar bottoes
                }
                else if (evento.equals("penalty"))
                {
                    ...
                    new AlertDialog.Builder(EquipaVisitante.this)
                ...
                else if (evento.equals("subtituicao"))
                {
                    ...
                    Toast.makeText(EquipaVisitante.this, "Nao foi escolhido um evento.", Toast.LENGTH_SHORT).show();


                evento = "";
                Toast.makeText(EquipaVisitante.this, "Golo: " + GRGolo + "\nLivre: " + GRLivre + "\nCanto: " + GRCanto + "\nPenalty: " + GRPenalty + "\nLancamento: " + GRLancamento + "\nCruzamento: " + GRCruzamento + "\nPasse: " + GRPasse + "\nPerda: " + GRPerda + "\nRemate: " + GRRemate, Toast.LENGTH_SHORT).show();
                Toast.makeText(EquipaVisitante.this, "Golo: " + GREventos[10] + "\nLivre: " + GREventos[8] + "\nCanto: " + GREventos[7] + "\nPenalty: " + GREventos[9] + "\nLancamento: " + GREventos[6] + "\nCruzamento: " + GREventos[5] + "\nPasse: " + GREventos[1] + "\nPerda: " + GREventos[2] + "\nRemate: " + GREventos[0] + "\nCorte: " + GREventos[3] + "\nRecuperacao: " + GREventos[4], Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void recuperacao ()
    {
        new AlertDialog.Builder(EquipaVisitante.this)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        dialog.dismiss();
                        Toast.makeText(EquipaVisitante.this, "Recuperacao", Toast.LENGTH_SHORT).show();
                        selectedPosition = ((AlertDialog) dialog).getListView().getCheckedItemPosition();
                        // Do something useful withe the position of the selected radio button
                        Toast.makeText(EquipaVisitante.this, "Posicao:" + selectedPosition + "Jogador:" + EquipaCasaNome[selectedPosition], Toast.LENGTH_SHORT).show();
    ...
    private void corte ()
    {
        new AlertDialog.Builder(EquipaVisitante.this)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        dialog.dismiss();
                        Toast.makeText(EquipaVisitante.this, "Corte", Toast.LENGTH_SHORT).show();
                        selectedPosition = ((AlertDialog) dialog).getListView().getCheckedItemPosition();
                        // Do something useful withe the position of the selected radio button
                        Toast.makeText(EquipaVisitante.this, "Posicao:" + selectedPosition + "Jogador:" + EquipaCasaNome[selectedPosition], Toast.LENGTH_SHORT).show();
                        //buscar a lista dos jogadores adversario, atravez do shared preferences
